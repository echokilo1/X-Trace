...
JAVA_HOME=/usr/lib/jvm/java-1.5.0-sun /usr/lib/jvm/java-1.5.0-sun/bin/java -Dlog4j.configuration=lib/log4j-proxy.properties -Dxtrace.reporter="edu.berkeley.xtrace.reporting.UdpReporter" -Dxtrace.udpdest="${1}:7831" -cp $CLASSPATH edu.berkeley.xtrace.server.XTraceProxy
